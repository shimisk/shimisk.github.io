...
export default function EntryEditor({
  ...
  return h('div', {
  ...
  }, initial ? "Edit Entry" : "New Entry")), h('div', {
    ...
    className: "editor-sticker-box"
  }, h('div', {
    className: "sticker-stage",
    onClick: () => setPickerOpen(true)
  }, sticker.length > 0 ? isImageSticker(sticker[0]) ? h('img', {
    className: "sticker-big-image",
    src: sticker[0],
    alt: stickerLabel(sticker[0])
  }) : h('div', {
    className: "sticker-big"
  }, sticker[0]) : h('div', {
    className: "sticker-add-ring"
  }, "＋"))), h('div', {
    className: "editor-write-box"
  }, h('textarea', {
    ...
    onClick: handleSave,
    disabled: !body.trim()
  }, "✨ Save Entry")), pickerOpen && h(StickerPicker, {
    selected: sticker,
    onChange: setSticker,
