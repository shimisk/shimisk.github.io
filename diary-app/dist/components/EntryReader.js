...
export default function EntryReader({
  ...
  return h('div', {
    ...
    className: "read-entry-box"
  }, h('div', {
    className: "read-meta-box"
  }, h('div', {
    className: "read-date"
  }, formatDateLong(entry.date)), entry.title && h('div', {
    className: "read-title"
  }, entry.title)), h('div', {
    className: "read-sticker-box"
  }, entry.sticker ? isImageSticker(entry.sticker) ? h('img', {
    className: "read-sticker-image",
    src: entry.sticker,
    alt: stickerLabel(entry.sticker)
  }) : h('div', {
    className: "read-sticker"
  }, entry.sticker) : h('div', {
    className: "read-sticker-placeholder",
    'aria-hidden': true
  }, "")), h('div', {
    className: "read-body"
  }, entry.body))), h('div', {
