...
export default function PinSetup({
  ...
  return h('div', {
    ...
    className: "setup-handle"
  }, h('div', {
    className: "setup-handle-bar"
  })), h('div', {
    className: "setup-top"
  }, h('span', {
    className: "setup-title"
  }, LABELS[step]), h('button', {
    className: "setup-cancel",
    onClick: onCancel
  }, "Cancel")), h('div', {
    className: `setup-dots${shake ? " shake" : ""}`
  }, [0, 1, 2, 3].map(i => h('div', {
    key: i,
    className: `setup-dot${pin.length > i ? " filled" : ""}`
  }))), h('div', {
    className: "setup-error"
  }, error), h('div', {
    className: "setup-step"
  }, LABELS[step]), h('div', {
    className: "setup-numpad"
