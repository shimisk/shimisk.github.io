export const THEMES = {
  witchy: {
    ...
    assets: {
      ...
      cards: ["assets/witchy/card-1.png", "assets/witchy/card-2.png", "assets/witchy/card-3.png", "assets/witchy/card-4.png", "assets/witchy/card-5.png"]
    },
    fallback: {
      appBg: "#0d0a1a",
      headerBg: "#150e2b",
...
export const STICKER_CATEGORIES = {
  mood: {
    label: "Mood",
    icon: "🌙",
    stickers: ["assets/witchy/stickers/angry.png", "assets/witchy/stickers/anxious.png", "assets/witchy/stickers/cozy.png", "assets/witchy/stickers/exhaust.png", "assets/witchy/stickers/happy.png", "assets/witchy/stickers/in-love.png", "assets/witchy/stickers/magical.png", "assets/witchy/stickers/mysterious.png", "assets/witchy/stickers/sad.png", "assets/witchy/stickers/sleepy.png"]
  }
};